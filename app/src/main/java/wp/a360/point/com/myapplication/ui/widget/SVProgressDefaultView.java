...
public class SVProgressDefaultView extends LinearLayout {
    private int resBigLoading = R.mipmap.em_ic_svstatus_loading;
    private int resInfo = R.mipmap.em_ic_svstatus_info;
    private int resSuccess = R.mipmap.em_ic_svstatus_success;
    private int resError = R.mipmap.em_ic_svstatus_error;
